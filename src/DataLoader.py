...
class DataLoader:
    ...
    def load_backgrounds(self, mosaic_size: int):
        ...
        cache_save_path = os.path.join(root_path, f'{prefix}_{datetime.now().strftime("%Y_%m_%d_%H:%M")}.pkl')
    ...
    def load_raw_components(self):
        ...
        mkdir_if_not_exists(self.save_path)
        cache_save_path = os.path.join(self.img_root_path, f'{RAW}_{datetime.now().strftime("%Y_%m_%d_%H:%M")}.pkl')
    ...
    def load_components(self):
        ...
        mkdir_if_not_exists(self.save_path)
        cache_save_path = os.path.join(self.save_path, f'{CROPPED}_{datetime.now().strftime("%Y_%m_%d_%H:%M")}.pkl')
